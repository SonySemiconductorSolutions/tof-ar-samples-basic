...
namespace TofArSamples.Body
{
    public class BodyViewSettings : ImageViewSettings
    {
        ...
        void MakeUIOffset()
        {
            ...
            itemOffsetX = settings.AddItem(" X", BodyModelController.OffsetMin,
            ...
            itemOffsetY = settings.AddItem(" Y", BodyModelController.OffsetMin,
                BodyModelController.OffsetMax, BodyModelController.OffsetStep,
                offset.y, ChangeOffsetY, 0, 0, lineAlpha);
            itemOffsetY.IsNotifyImmediately = true;

            itemOffsetZ = settings.AddItem(" Z", BodyModelController.OffsetMin,
                BodyModelController.OffsetMax, BodyModelController.OffsetStep,
