...
namespace TofArSamples.HumanPointCloud
{
    public class HumanPointCloudViewSettings : PointCloudViewSettings
    {
        ...
        {
            itemColorDisplayToggle = settings.AddItem("Color Display",
             humanPointCloudController.ColorDisplay, ChangeColorDisplay);
            ...
            itemHumanSegmentationToggle = settings.AddItem("Segment Pointcloud",
             humanPointCloudController.SegmentHuman, ChangeHumanSegmentation);
            ...
            itemThresholdSlider = settings.AddItem("Segmentation\nThreshold",
                HumanPointCloudController.thresholdMin,
                HumanPointCloudController.thresholdMax,
                HumanPointCloudController.thresholdStep,
                humanPointCloudController.Threshold, ChangeThreshold, -2);
